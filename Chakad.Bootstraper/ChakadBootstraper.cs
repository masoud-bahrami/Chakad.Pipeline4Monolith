...
namespace Chakad.Bootstraper
{
    public static class ChakadBootstraper
    {
        ...
        {
            new MyEventSubscriber1().InterestedIn(typeof(MyDomainEvent));
            new MyEventSubscriber2().InterestedIn(typeof(MyDomainEvent));
            new MyEventSubscriber().InterestedIn(typeof(MyDomainEvent));
        }
